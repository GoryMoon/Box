package com.github.GoryMoon.util;
...
public class BukkitUtils {
	  ...
	  private static final Logger log = Bukkit.getLogger();
	    ...
	    public static void info(String msg) {
	        ...
	        out.append("[Box v" + Box.getInstance().getDescription().getVersion()  + "] ");
	        out.append(msg);
	    ...
	    public static void warning(String msg, Exception ex) {
	        log.log(Level.WARNING, "[Box v" + Box.getInstance().getDescription().getVersion()  + "] " + msg + ":", ex);
	    }
	    ...
	    public static void severe(String msg, Exception ex) {
	        log.log(Level.SEVERE, "[Box v" + Box.getInstance().getDescription().getVersion()  + "] " + msg + ":", ex);
	    }
	    ...
	    public static void debug(String msg) {
	        if (Box.getInstance().getConf().debug) {
	            info("DEBUG: " + msg);
	        }
	    }
